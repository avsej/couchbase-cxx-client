...
function(
  ...
  try_compile(
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FILE} CXX_STANDARD 17
    OUTPUT_VARIABLE TEST_OUTPUT)

  if(NOT TEST_RESULT)
    message(WARNING "Failed to compile ${FILESYSTEM_HEADER} without OPTIONAL_LIBS(${OPTIONAL_LIBS}):\n${TEST_OUTPUT}")
    ...
    foreach(OPTIONAL_LIB IN LISTS OPTIONAL_LIBS)
      ...
      message(WARNING "Failed to compile ${FILESYSTEM_HEADER} with OPTIONAL_LIB(${OPTIONAL_LIB}):\n${TEST_OUTPUT}")
    endforeach()
  endif()
