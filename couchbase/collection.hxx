...
class collection
{
  public:
     ...
     * @committed
     */
    void mutate_in(std::string document_id, mutate_in_specs specs, const mutate_in_options& options, mutate_in_handler&& handler) const;
     ...
     * @committed
     */
    void lookup_in(std::string document_id, lookup_in_specs specs, const lookup_in_options& options, lookup_in_handler&& handler) const;
