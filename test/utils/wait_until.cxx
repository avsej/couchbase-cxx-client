                    ...
                    std::size_t expected_number_of_documents_indexed)
{
    ...
    CB_LOG_INFO("completed: {}, index_name \"{}\" -> \"{}\", ec: {}", operation_completed, index_name, resp.name, resp.ctx.ec.message());
    ...
    operation_completed = wait_until_indexed(integration.cluster, index_name, expected_number_of_documents_indexed);
