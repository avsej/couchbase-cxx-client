    ...
    */
      ...
      , metadata_(json.optional<std::string>("scas").value_or(""))
    {
        ...
        if (const auto* doc = json.find("doc"); doc != nullptr) {
            content_ = { core::utils::json::generate_binary(doc->get_object()), codec::codec_flags::json_common_flags };
        }
    }
    ...
    /** @internal */
    static transaction_get_result create_from(const transaction_get_result& document, codec::encoded_value content);
