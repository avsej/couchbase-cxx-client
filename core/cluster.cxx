  ...
  public:
    ...
    void do_open(utils::movable_function<void(std::error_code)> handler)
    {
        // Warn users if they attempt to use Capella without TLS being enabled.
        {
            ...
            constexpr static std::string_view suffix{ "cloud.couchbase.com" };
...
DEFINE_OPERATION(get_all_replicas)
DEFINE_OPERATION(get_and_lock)
DEFINE_OPERATION(get_and_touch)
DEFINE_OPERATION(get_any_replica)
DEFINE_OPERATION(get_projected)
DEFINE_OPERATION(increment)
DEFINE_OPERATION(insert)
DEFINE_OPERATION(lookup_in)
DEFINE_OPERATION(mutate_in)
DEFINE_OPERATION(prepend)
DEFINE_OPERATION(query)
DEFINE_OPERATION(remove)
DEFINE_OPERATION(replace)
DEFINE_OPERATION(search)
DEFINE_OPERATION(touch)
DEFINE_OPERATION(unlock)
DEFINE_OPERATION(upsert)
DEFINE_OPERATION(document_view)
DEFINE_OPERATION(http_noop)

DEFINE_OPERATION(management::analytics_dataset_create)
DEFINE_OPERATION(management::analytics_dataset_drop)
DEFINE_OPERATION(management::analytics_dataset_get_all)
DEFINE_OPERATION(management::analytics_dataverse_create)
DEFINE_OPERATION(management::analytics_dataverse_drop)
DEFINE_OPERATION(management::analytics_get_pending_mutations)
DEFINE_OPERATION(management::analytics_index_create)
DEFINE_OPERATION(management::analytics_index_drop)
DEFINE_OPERATION(management::analytics_index_get_all)
DEFINE_OPERATION(management::analytics_link_connect)
DEFINE_OPERATION(management::analytics_link_disconnect)
DEFINE_OPERATION(management::analytics_link_drop)
DEFINE_OPERATION(management::analytics_link_get_all)
DEFINE_OPERATION(management::bucket_create)
DEFINE_OPERATION(management::bucket_drop)
DEFINE_OPERATION(management::bucket_flush)
DEFINE_OPERATION(management::bucket_get)
DEFINE_OPERATION(management::bucket_get_all)
DEFINE_OPERATION(management::bucket_update)
DEFINE_OPERATION(management::collection_create)
DEFINE_OPERATION(management::collection_drop)
DEFINE_OPERATION(management::collections_manifest_get)
DEFINE_OPERATION(management::scope_create)
DEFINE_OPERATION(management::scope_drop)
DEFINE_OPERATION(management::scope_get_all)
DEFINE_OPERATION(management::eventing_deploy_function)
DEFINE_OPERATION(management::eventing_drop_function)
DEFINE_OPERATION(management::eventing_get_all_functions)
DEFINE_OPERATION(management::eventing_get_function)
DEFINE_OPERATION(management::eventing_get_status)
DEFINE_OPERATION(management::eventing_pause_function)
DEFINE_OPERATION(management::eventing_resume_function)
DEFINE_OPERATION(management::eventing_undeploy_function)
DEFINE_OPERATION(management::eventing_upsert_function)
DEFINE_OPERATION(management::view_index_drop)
DEFINE_OPERATION(management::view_index_get)
DEFINE_OPERATION(management::view_index_get_all)
DEFINE_OPERATION(management::view_index_upsert)
DEFINE_OPERATION(management::change_password)
DEFINE_OPERATION(management::group_drop)
DEFINE_OPERATION(management::group_get)
DEFINE_OPERATION(management::group_get_all)
DEFINE_OPERATION(management::group_upsert)
DEFINE_OPERATION(management::role_get_all)
DEFINE_OPERATION(management::user_drop)
DEFINE_OPERATION(management::user_get)
DEFINE_OPERATION(management::user_get_all)
DEFINE_OPERATION(management::user_upsert)
DEFINE_OPERATION(management::search_get_stats)
DEFINE_OPERATION(management::search_index_analyze_document)
DEFINE_OPERATION(management::search_index_control_ingest)
DEFINE_OPERATION(management::search_index_control_plan_freeze)
DEFINE_OPERATION(management::search_index_control_query)
DEFINE_OPERATION(management::search_index_drop)
DEFINE_OPERATION(management::search_index_get)
DEFINE_OPERATION(management::search_index_get_all)
DEFINE_OPERATION(management::search_index_get_documents_count)
DEFINE_OPERATION(management::search_index_get_stats)
DEFINE_OPERATION(management::search_index_upsert)
DEFINE_OPERATION(management::query_index_build)
DEFINE_OPERATION(management::query_index_build_deferred)
DEFINE_OPERATION(management::query_index_create)
DEFINE_OPERATION(management::query_index_drop)
DEFINE_OPERATION(management::query_index_get_all)
DEFINE_OPERATION(management::query_index_get_all_deferred)

DEFINE_OPERATION(management::bucket_describe)
DEFINE_OPERATION(management::cluster_describe)
DEFINE_OPERATION(management::freeform)

#define DEFINE_OPERATION_IMPL(name)                                                                                                        \
    void cluster::execute(impl::name##_request request, utils::movable_function<void(impl::name##_response)>&& handler) const              \
    {                                                                                                                                      \
        return impl_->execute(std::move(request), std::move(handler));                                                                     \
    }

DEFINE_OPERATION_IMPL(get_replica)
DEFINE_OPERATION_IMPL(observe_seqno)

#define DEFINE_ANALYTICS_LINK_OPERATION(name, type)                                                                                        \
    void cluster::execute(operations::management::analytics_link_##name##_request<management::analytics::type##_link> request,             \
                          utils::movable_function<void(operations::management::analytics_link_##name##_response)>&& handler) const         \
    {                                                                                                                                      \
        return impl_->execute(std::move(request), std::move(handler));                                                                     \
    }

DEFINE_ANALYTICS_LINK_OPERATION(replace, azure_blob_external)
DEFINE_ANALYTICS_LINK_OPERATION(replace, couchbase_remote)
DEFINE_ANALYTICS_LINK_OPERATION(replace, s3_external)
