  ...
  public:
    ...
    void query(std::string statement, query_options::built options, query_handler&& handler) const
    {
        return core_.execute(
          core::impl::build_query_request(std::move(statement), query_context_, options),
    ...
    {
        return core_.execute(core::impl::build_analytics_request(std::move(statement), options, bucket_name_, name_),
