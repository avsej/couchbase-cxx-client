...
class collection_impl : public std::enable_shared_from_this<collection_impl>
{
  public:
    ...
    void unlock(std::string document_key, couchbase::cas cas, unlock_options::built options, unlock_handler&& handler)
    {
        core_.execute(
    ...
    void exists(std::string document_key, exists_options::built options, exists_handler&& handler)
    {
        core_.execute(
    ...
    void upsert(std::string document_key, codec::encoded_value encoded, upsert_options::built options, upsert_handler&& handler)
    {
    ...
    void insert(std::string document_key, codec::encoded_value encoded, insert_options::built options, insert_handler&& handler)
    {
        auto value = std::move(encoded);
        auto id = core::document_id{
            bucket_name_,
    ...
    void replace(std::string document_key, codec::encoded_value encoded, replace_options::built options, replace_handler&& handler)
    {
        auto value = std::move(encoded);
        auto id = core::document_id{
            bucket_name_,
...
void
collection::mutate_in(std::string document_id, mutate_in_specs specs, const mutate_in_options& options, mutate_in_handler&& handler) const
{
    return impl_->mutate_in(std::move(document_id), specs.specs(), options.build(), std::move(handler));
}

auto
collection::mutate_in(std::string document_id, mutate_in_specs specs, const mutate_in_options& options) const
...
void
collection::lookup_in(std::string document_id, lookup_in_specs specs, const lookup_in_options& options, lookup_in_handler&& handler) const
{
    return impl_->lookup_in(std::move(document_id), specs.specs(), options.build(), std::move(handler));
}

auto
collection::lookup_in(std::string document_id, lookup_in_specs specs, const lookup_in_options& options) const
