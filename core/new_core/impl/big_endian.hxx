...
namespace couchbase::new_core::impl::big_endian
{
template<typename Buffer>
constexpr auto
read_uint64(const Buffer& buffer, std::size_t offset) -> std::uint64_t
{
...
template<typename Buffer>
constexpr auto
read_uint32(const Buffer& buffer, std::size_t offset) -> std::uint32_t
{
...
template<typename Buffer>
constexpr auto
read_uint16(const Buffer& buffer, std::size_t offset) -> std::uint16_t
{
...
template<typename Buffer>
auto
read(const Buffer& buffer, std::size_t offset, std::size_t length) -> std::vector<std::byte>
{
...
template<typename Buffer>
static void
put_uint32(Buffer& bytes, std::uint32_t value)
{
