...
public:
    ...
    : CLI::App{ "Generates keys with various properties.", "keygen" }
  {
    ...
    add_option("--fixed-length", fixed_length_, "The length of the key to generate.")
      ->default_val(6);
    add_flag("--randomize", randomize_, "Generate different keys every time.")->default_val(false);
    ...
    add_flag("--json", json_, "Output generation result as JSON.")->default_val(false);
